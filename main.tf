# Find the latest Ubuntu 22.04 LTS AMI in the chosen region automatically (no hardcoded AMI IDs)
...
resource "aws_security_group" "ec2_sg" {
  name        = "ec2-security-group-rakesh"   
...
resource "aws_instance" "my_ec2" {
  ...
  tags = {
    Name = "Rakesh-terraform-EC2-Lab-Ubuntu"
  }
}
